...
\author{Syngjoo Choi (SNU), Booyuel Kim (SNU), Minseon Park (Wisconsin), Yoonsoo Park (SMU), Euncheol Shin (KAIST)}
\institute[]
{Presenter: Euncheol Shin (KAIST) \\
\medskip
{\tt{eshin.econ@kaist.ac.kr}}
}
\date{%June, 2017
...
\begin{frame}{Measurement: Risk Preferences}
\nk
...
\item Basic statistics of individual  and collective CCEIs:
	\mk
	\begin{itemize}
	
	\item individual average: 0.897 (0.136)
	\mk
	
	\item collective average: 0.910 (0.141).
...
\toprule
\multirow{2}{*}{\textbf{Collective CCEI}}	& & \multicolumn{3}{c}{\textbf{Coefficient}}  \\
		        \cline{3-5}
																& & Model 1 & & Model 2 \\
\hline
\hline
\multirow{2}{*}{CCEI\underline{{ }{ }}Max}  & &  $0.368^{***}$ & & $0.302^{***}$   \\
                                                                        & & $(0.083)$         & & $(0.089)$          \\
\multirow{2}{*}{CCEI\underline{{ }{ }}Distance}  & & $-0.277^{***}$ & & $-0.233^{***}$  \\
                                                                                & & $(0.056)$        & & $(0.058)$       \\
\hline
...
\multirow{2}{*}{Math\underline{{ }{ }}Distance}  & &        & &  $-0.010^{**}$      \\
                                                						        & &          & &  $(0.005)$     \\
\multirow{2}{*}{Constant}      & & $0.582^{***}$   & & $0.664^{***}$  \\
                                                 	  & &  $(0.077)$        & &  $(0.084)$  \\
\hline
\hline
Class Fixed Effect           & & Yes      & & Yes         \\
Individual Characteristics   & & No       & & Yes         \\
School Characteristics       & & No       & & Yes         \\
Friendship                   & & No       & & Yes         \\
Observations                 & & $786$    & & $786$       \\
$R$-squared                  & & $0.200$  & & $0.235$     \\
\hline
\multicolumn{5}{r}{\small{$*$Throughout the paper, we clustered standard error in class level.}} \\
\bottomrule 
\end{tabular}
...
\item Basic statistics of individual and collective RAs:
	\mk
	\begin{itemize}
...
\begin{tabular}{l  lc lc}
\toprule
\multirow{2}{*}{\textbf{Collective Risk Aversion}}	& & \multicolumn{3}{c}{\textbf{Coefficient}}  \\
		        \cline{3-5}
																& & Model 1 & & Model 2 \\
\hline
\hline
\multirow{2}{*}{Risk\underline{{ }{ }}Aversion\underline{{ }{ }}Max}  & &  $0.792^{***}$  & & $0.759^{***}$ \\
& &  $(0.066)	$  & & $(0.073)$    \\
\multirow{2}{*}{Risk\underline{{ }{ }}Aversion\underline{{ }{ }}Distance}  & &  $-0.421^{***}$  & &  $-0.434^{***}$   \\
           & &  $(0.053)$  & & $(0.062)$   \\
\hline
\multirow{2}{*}{Math\underline{{ }{ }}Score\underline{{ }{ }}Max}  
& &     & &  $0.000$  \\
& &    & &  $(0.005)$     \\
\multirow{2}{*}{Math\underline{{ }{ }}Distance} & &  & &  $0.005$      \\
               			& &          & &  $(0.004)$     \\
\multirow{2}{*}{Constant}      & & $0.004$    & & $-0.175^{**}$  \\
                               & & $(0.027)$  & & $(0.077)$  \\
\hline
\hline
Class Fixed Effect             & & Yes       & & Yes      \\
...
\item For those choices, we measure \textbf{welfare loss} of a group as
	\sk
	\begin{align*}
	\text{Welfare Loss} = \frac{1}{18} \sum_{k = 1}^{18} \frac{1}{2} \sum_{i = 1}^2 \frac{U_i(x_{kr}) - U_i(x_{kc})}{U_i(x_{kr}) - U_i(x_{kw})},
	\end{align*}
	\sk
	where
	\sk
	...
	\item $x_{kc}$: group's choice in $k$-th round
	\sk
	
	\item $x_{kr}$: group's reference choice in $k$-th round
	\sk
	
	\item $x_{kw}$: group's worst choice in $k$-th round.
