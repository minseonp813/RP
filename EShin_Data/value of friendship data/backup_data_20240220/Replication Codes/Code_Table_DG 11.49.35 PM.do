...
*estpost sum female height weight motherage fatherage motheredu fatheredu birthorder firstborn mathscore selfesteem outgoing agreeable conscientious stable opened if treatment == 0 

*esttab using FINAL_summary_PanelA.xls, cells("mean(fmt(3)) sd(fmt(3))") replace 
...
*estpost sum distance_1 distance_2 distance_3 distance_4 distance_5 distance_6to11 distance_12 dt_share if treatment == 0 

*esttab using FINAL_summary_PanelB.xls, cells("mean(fmt(3)) sd(fmt(3))") replace
