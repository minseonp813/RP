...
theta_PanelA = [theta_PanelA;[0,0, did(1,3:4)]];
...
save('results_PanelA.mat','theta_PanelA', 'theta_PanelACI', 'theta0', 'theta1', 'CIs', 'theta0did', 'theta1did')
