...
********************************************************************************
use "/Users/euncheolshin/Dropbox/Academic_Sharings/P-RP/Data/Risk_ByPair.dta", clear
set more off
...
reg ccei_col i.ccei_both90 i.riskaversionpair i.class, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table1_ColCCEI.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append

reg ccei_col i.ccei_both90 ///
...
reg uloss_col i.ccei_col90 i.class, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table5_Coluloss.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append

reg uloss_col i.ccei_col90  ///
ib(2).malepair_co mathscore_max mathscore_dist height_gr_max height_gr_dist i.friendship i.class, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table5_Coluloss.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append
...
reg uloss_col i.ccei_both90 i.ccei_col90 i.class, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table5_Coluloss.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append

reg uloss_col i.ccei_both90 i.ccei_col90  ///
ib(2).malepair_co mathscore_max mathscore_dist height_gr_max height_gr_dist i.friendship i.class, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table5_Coluloss.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append
...
reg varian_col i.varian_both90 i.class, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table1_ColVarian.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) replace

reg varian_col i.varian_both90 i.riskaversionpair i.class, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table1_ColVarian.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append

reg varian_col i.varian_both90 ///
ib(2).malepair_co mathscore_max mathscore_dist height_gr_max height_gr_dist i.friendship i.class, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table1_ColVarian.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append

reg varian_col i.varian_both90 i.riskaversionpair ///
ib(2).malepair_co mathscore_max mathscore_dist height_gr_max height_gr_dist i.friendship i.class, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table1_ColVarian.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append
...
reg riskpremium_col i.riskpremiumpair i.class if ccei_both90==2, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table2_Colriskpremium.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) replace

reg riskpremium_col i.riskpremiumpair ///
...
reg riskpremium_crra_col i.riskpremium_crrapair i.class if ccei_both90==2 , r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table2_Colriskpremium.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append

reg riskpremium_crra_col i.riskpremium_crrapair ///
ib(2).malepair_co mathscore_max mathscore_dist height_gr_max height_gr_dist i.friendship i.class if ccei_both90==2, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table2_Colriskpremium.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append
...
** Table 3_Variantions
putexcel set "C:\Users\Minseon Park\Dropbox\RP\Writing\Table3_Colrisktype.xls", sheet("Table3_all") modify
putexcel  A2=("Both EUT") A3=("One EUT/The other RDU") A4=("Both RDU") A5=("Total")
putexcel  B1=("Collective EUT") C1=("Collective RDU")  D1=("Total")
...
reg uloss_col ccei_col90 i.class if ccei_both90==2, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table5_Coluloss_Variations.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append
...
reg uloss_col i.ccei_both90 ccei_col90 i.class if ccei_both90==2, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table5_Coluloss_Variations.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append
