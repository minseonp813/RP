...
save "data/finalized_panel_final_250831.dta", replace
...
gen oneside_friendship = (friendship==1)
gen mutual_friendship = (friendship==2)

gen corner_ratio_max = max(corner_ratio_1, corner_ratio_2)
gen corner_ratio_dist = abs(corner_ratio_1 - corner_ratio_2)
