...
m1 = 1;
for i =  1:2*N
    [~,c,m] = find(VarName1==VarName1(m1) & VarName7==VarName7(m1)) ;
    M=sum(m);
    m2=m1+M-1 ;
    ...
    out = [VarName1(m1),VarName7(m1),alpha,se1,rho,se2,ssr];
    results(i,:) = out;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    btout = bstrapm1(x,y,xmax,ymax,200);
%    btid = ones(500,1)*id; 
%    btres = [btid,btout];
...
m1=m1+M ;  
     ...
     save CARA_alpha_0_1_rho_0_3 results
end
...
%sendmail(emailto, 'My Subject', 'My message','results1208.mat');
