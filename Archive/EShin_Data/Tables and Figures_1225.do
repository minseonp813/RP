...
opt1( lc(teal olive navy) lp(solid shortdash longdash) ) ///
legend(order(1 "Both Less Risk Averse Pairs (N=41)" 2 "Heterogeneous Pairs (N=71)" ///
3 "Both Risk Averse Pairs (N=46)" ) col(1))  ///
note(`"Kolmogorov-Smirnov Distance(corrected p-value):"' `" 1. (Heterogeneous=Both Less Risk Averse) `d1'(`p1')"' ///
...
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table2_Colriskaversion.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) replace

reg riskaversion_col riskaversion_ind_max riskaversion_ind_dist varian_ind_max varian_ind_dist i.class, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table2_Colriskaversion.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append
...
reg riskaversion_col riskaversion_ind_max riskaversion_ind_dist varian_ind_max varian_ind_dist ///
ib(1).malepair_co mathscore_max mathscore_dist height_gr_max height_gr_dist i.friendship i.class, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table2_Colriskaversion.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append

reg riskaversion_col riskaversion_ind_max riskaversion_max_nonmover riskaversion_ind_dist varian_ind_max varian_ind_dist ///
ib(1).malepair_co mathscore_max mathscore_dist height_gr_max height_gr_dist i.friendship i.class, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table2_Colriskaversion.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append

** Table 3
putexcel set "C:\Users\Minseon Park\Dropbox\RP\Writing\Table3_Colrisktype.xls", sheet("Table3") replace
putexcel  A2=("Both EUT") A3=("One EUT/The other RDU") A4=("Both RDU") A5=("Total")
putexcel  B1=("Collective EUT") C1=("Collective RDU")  D1=("Total")

tab rdupair rdu_col if varian_both90==2 & varian_col90==1 , matcell(Tab) 
tab rdupair if varian_both90==2 & varian_col90==1, matcell(Tab1)
tab rdu_col if varian_both90==2 & varian_col90==1, matcell(Tab2)
matrix TTab2=Tab2'
...
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table4_Colrdu.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) replace
...
** Figure 4A
ksmirnov uloss_col, by(varian_col90)
local d1=trim("`: display %9.2f r(D)'")
local p1=trim("`: display %9.2f r(p_cor)'")

cdfplot uloss_col, by(varian_col90) xlabel(0(0.05)1) ///
...
graph export "C:\Users\Minseon Park\Dropbox\RP\Writing\Figures\Figure4A_ULoss_Varian.png", as(png) replace
...
note(`"Kolmogorov-Smirnov Distance(corrected p-value):`d1'(`p1')"') ///
xtitle(Group Choices' Inefficiency)
graph export "C:\Users\Minseon Park\Dropbox\RP\Writing\Figures\Figure4B_ULoss_Varian.png", as(png) replace

** Table 5
reg uloss_col varian_ind_max varian_ind_dist i.class, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table5_Coluloss.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) replace

reg uloss_col varian_ind_max varian_ind_dist  ///
ib(1).malepair_co mathscore_max mathscore_dist height_gr_max height_gr_dist i.friendship i.class, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table5_Coluloss.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append
...
`"2. (Heterogeneous=Both Risk Averse) `d2'(`p2')"' `"Risk Averse=(Individual Risk Aversion >= the Median) "') ///
xtitle(Collective Non-parametric Risk Aversion)
graph export "C:\Users\Minseon Park\Dropbox\RP\Writing\Figures\Figure2A_riskaversion_varian`t'.png", as(png) replace
}

** Figure 2B_Variations
foreach t in 99 95 90 {
ksmirnov riskpremium_col if riskpremiumpair~=2 & varian_both`t'==2, by(riskpremiumpair)
local d1=trim("`: display %9.2f r(D)'")
local p1=trim("`: display %9.2f r(p_cor)'")
ksmirnov riskpremium_col if riskpremiumpair~=0 & varian_both`t'==2, by(riskpremiumpair)
local d2=trim("`: display %9.2f r(D)'")
local p2=trim("`: display %9.2f r(p_cor)'")

cdfplot riskpremium_col if varian_both`t'==2, by(riskpremiumpair) xlabel(-1(0.2)1.8) ///
opt1( lc(teal olive navy) lp(solid shortdash longdash) ) ///
legend(order(1 "Both Less Risk Averse Pairs" 2 "Heterogeneous Pairs" ///
3 "Both Risk Averse Pairs" ) col(1))  ///
note(`"Kolmogorov-Smirnov Distance(corrected p-value):"' `" 1. (Heterogeneous=Both Less Risk Averse) `d1'(`p1')"' ///
`"2. (Heterogeneous=Both Risk Averse) `d2'(`p2')"' `"Risk Averse=(Individual Risk Premium >= the Median) "') ///
xtitle(Collective Risk Premium)
graph export "C:\Users\Minseon Park\Dropbox\RP\Writing\Figures\Figure2B_riskpremium_varian`t'.png", as(png) replace
}
foreach t in 99 95 90 {
ksmirnov riskpremium_crra_col if riskpremium_crrapair~=2 & varian_both`t'==2, by(riskpremium_crrapair)
local d1=trim("`: display %9.2f r(D)'")
local p1=trim("`: display %9.2f r(p_cor)'")
ksmirnov riskpremium_crra_col if riskpremium_crrapair~=0 & varian_both`t'==2, by(riskpremium_crrapair)
local d2=trim("`: display %9.2f r(D)'")
local p2=trim("`: display %9.2f r(p_cor)'")

cdfplot riskpremium_crra_col if varian_both`t'==2, by(riskpremium_crrapair) xlabel(-1(0.5)5) ///
opt1( lc(teal olive navy) lp(solid shortdash longdash) ) ///
legend(order(1 "Both Less Risk Averse Pairs" 2 "Heterogeneous Pairs" ///
3 "Both Risk Averse Pairs" ) col(1))  ///
note(`"Kolmogorov-Smirnov Distance(corrected p-value):"' `" 1. (Heterogeneous=Both Less Risk Averse) `d1'(`p1')"' ///
`"2. (Heterogeneous=Both Risk Averse) `d2'(`p2')"' `"Risk Averse=(Individual Risk Premium >= the Median) "') ///
xtitle(Collective Risk Premium)
graph export "C:\Users\Minseon Park\Dropbox\RP\Writing\Figures\Figure2B_riskpremium_crra_varian`t'.png", as(png) replace
}

** Table 2_Variations
reg riskpremium_col riskpremium_ind_max riskpremium_ind_dist i.class if varian_both90==2, r cl(class)
...
ib(1).malepair_co mathscore_max mathscore_dist height_gr_max height_gr_dist i.friendship i.class if varian_both90==2, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table2_Colriskpremium.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append
...
reg riskpremium_crra_col riskpremium_crra_ind_max riskpremium_crra_ind_dist i.class if varian_both90==2 , r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table2_Colriskpremium.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append
...
** Table 3_Variantions
putexcel set "C:\Users\Minseon Park\Dropbox\RP\Writing\Table3_Colrisktype.xls", sheet("Table3_ccei") replace
putexcel  A2=("Both EUT") A3=("One EUT/The other RDU") A4=("Both RDU") A5=("Total")
putexcel  B1=("Collective EUT") C1=("Collective RDU")  D1=("Total")
...
putexcel set "C:\Users\Minseon Park\Dropbox\RP\Writing\Table3_Colrisktype.xls", sheet("Table3_ccei_crra") modify
putexcel  A2=("Both EUT") A3=("One EUT/The other RDU") A4=("Both RDU") A5=("Total")
putexcel  B1=("Collective EUT") C1=("Collective RDU")  D1=("Total")
...
putexcel set "C:\Users\Minseon Park\Dropbox\RP\Writing\Table3_Colrisktype.xls", sheet("Table3_varian90") modify
putexcel  A2=("Both EUT") A3=("One EUT/The other RDU") A4=("Both RDU") A5=("Total")
putexcel  B1=("Collective EUT") C1=("Collective RDU")  D1=("Total")
...
putexcel set "C:\Users\Minseon Park\Dropbox\RP\Writing\Table3_Colrisktype.xls", sheet("Table3_varian90_crra") modify
putexcel  A2=("Both EUT") A3=("One EUT/The other RDU") A4=("Both RDU") A5=("Total")
putexcel  B1=("Collective EUT") C1=("Collective RDU")  D1=("Total")
...
putexcel set "C:\Users\Minseon Park\Dropbox\RP\Writing\Table3_Colrisktype.xls", sheet("Table3_varian") modify
putexcel  A2=("Both EUT") A3=("One EUT/The other RDU") A4=("Both RDU") A5=("Total")
putexcel  B1=("Collective EUT") C1=("Collective RDU")  D1=("Total")

tab rdupair rdu_col if varian_ind>=0.7 & varian_ind2>=0.7 & varian_col>=0.7, matcell(Tab) 
tab rdupair if varian_ind>=0.7 & varian_ind2>=0.7 & varian_col>=0.7, matcell(Tab1)
tab rdu_col if varian_ind>=0.7 & varian_ind2>=0.7 & varian_col>=0.7, matcell(Tab2)
matrix TTab2=Tab2'
putexcel B2=matrix(Tab) D2=matrix(Tab1) B5=matrix(TTab2) D5=(r(N))

putexcel set "C:\Users\Minseon Park\Dropbox\RP\Writing\Table3_Colrisktype.xls", sheet("Table3_varian_crra") modify
putexcel  A2=("Both EUT") A3=("One EUT/The other RDU") A4=("Both RDU") A5=("Total")
putexcel  B1=("Collective EUT") C1=("Collective RDU")  D1=("Total")

tab rdu_crrapair rdu_crra_col if varian_ind>=0.7 & varian_ind2>=0.7 & varian_col>=0.7, matcell(Tab) 
tab rdu_crrapair if varian_ind>=0.7 & varian_ind2>=0.7 & varian_col>=0.7, matcell(Tab1)
tab rdu_crra_col if varian_ind>=0.7 & varian_ind2>=0.7 & varian_col>=0.7, matcell(Tab2)
matrix TTab2=Tab2'
putexcel B2=matrix(Tab) D2=matrix(Tab1) B5=matrix(TTab2) D5=(r(N))
...
reg rdu_col i.rdupair i.class if varian_ind>=0.7 & varian_ind2>=0.7 & varian_col>=0.7, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table4_Colrdu_Appendix.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append

reg rdu_col i.rdupair ///
ib(1).malepair_co mathscore_max mathscore_dist height_gr_max height_gr_dist i.friendship i.class ///
if varian_ind>=0.7 & varian_ind2>=0.7 & varian_col>=0.7, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table4_Colrdu_Appendix.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append
...
ytitle(Fraction of subjects(%))
graph export "C:\Users\Minseon Park\Dropbox\RP\Writing\Figures\Figure3B_ULoss_CCEI90.png", as(png) replace

twoway (histogram uloss_col if varian_ind>=0.7 & varian_ind2>=0.7, percent bin(25) ) , xlabel(0(0.05)1) ylabel(0(10)40) ///
note(`"Including only both individuals Varians>=0.7"') xtitle(Group Choices' Inefficiency) ///
ytitle(Fraction of subjects(%))
graph export "C:\Users\Minseon Park\Dropbox\RP\Writing\Figures\Figure3B_ULoss_Varian70.png", as(png) replace
...
note(`"Kolmogorov-Smirnov Distance(corrected p-value):`d1'(`p1')"') ///
xtitle(Group Choices' Inefficiency)
graph export "C:\Users\Minseon Park\Dropbox\RP\Writing\Figures\Figure4B_ULoss_CCEI90.png", as(png) replace

g varian_col70=cond(varian_col>0.7,1,0)

ksmirnov uloss_col if varian_ind>=0.7 & varian_ind2>=0.7, by(varian_col70)
local d1=trim("`: display %9.2f r(D)'")
local p1=trim("`: display %9.2f r(p_cor)'")

cdfplot uloss_col if varian_ind>=0.7 & varian_ind2>=0.7, by(varian_col70) xlabel(0(0.05)1) ///
opt1( lc(teal olive) lp(solid shortdash) ) ///
legend(order(1 "Collective Varian<=0.7" 2 "Collective Varian>0.7") col(1))  ///
note(`"Kolmogorov-Smirnov Distance(corrected p-value):`d1'(`p1')"') ///
xtitle(Group Choices' Inefficiency)
graph export "C:\Users\Minseon Park\Dropbox\RP\Writing\Figures\Figure4B_ULoss_Varian70.png", as(png) replace
...
reg uloss_col varian_ind_max varian_ind_dist i.class if varian_ind>=0.7 & varian_ind2>=0.7, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table5_Coluloss_Variations.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append

reg uloss_col varian_ind_max varian_ind_dist  ///
ib(1).malepair_co mathscore_max mathscore_dist height_gr_max height_gr_dist i.friendship i.class if varian_ind>=0.7 & varian_ind2>=0.7, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table5_Coluloss_Variations.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append

reg uloss_col riskaversion_ind_max riskaversion_ind_dist i.class if varian_ind>=0.7 & varian_ind2>=0.7, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table5_Coluloss_Variations.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append
...
reg uloss_col varian_ind_max varian_ind_dist ///
riskaversion_ind_max riskaversion_ind_dist i.class if varian_ind>=0.7 & varian_ind2>=0.7, r cl(class)
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\Table5_Coluloss_Variations.xls", ///
bdec(3) cdec(3) drop(i.class) label addtext(Class FE, YES) append
...
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\SummaryStat.xls", replace ///
...
outreg2 using "C:\Users\Minseon Park\Dropbox\RP\Writing\SummaryStat.xls", append ///
