function y = psobjPanelC(x, fparameters)
...
schools = fparameters(:,6);
time = fparameters(:,10);
mij_emp = fparameters(:,11);
...
% data
graphdata = fparameters(:,7);
distancedata1 = fparameters(:,8);
distancedata2 = fparameters(:,9);
