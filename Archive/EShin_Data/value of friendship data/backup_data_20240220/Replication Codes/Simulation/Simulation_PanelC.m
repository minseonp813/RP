...
disp('**************************************************************')
disp('Run a simulation to get results in Panel C')
disp('**************************************************************')

load('nlcoefficients.mat')
coeff00 = nlcoefficients(9,:);
coeff01 = nlcoefficients(10,:);
coeff10 = nlcoefficients(11,:);
coeff11 = nlcoefficients(12,:);
...
% set x0
if treatment == 0 && time == 0
    x0 = [3.84531250000000,1.89843750000000];
elseif treatment == 0 && time == 1
    x0 = [4.61562500000000,2.35000000000000];
elseif treatment == 1 && time == 0 
    x0 = [4.03750000000000,2.62500000000000];
elseif treatment == 1 && time == 1
    x0 = [3.87500000000000,2.20468750000000];
else
    disp('error')
end
%x0 = [psum/2, psum/2];
...
save('results_PanelC.mat','theta_PanelC', 'theta_PanelCCI', 'theta00', 'theta11', 'CIs', 'theta00did',  'theta11did')
