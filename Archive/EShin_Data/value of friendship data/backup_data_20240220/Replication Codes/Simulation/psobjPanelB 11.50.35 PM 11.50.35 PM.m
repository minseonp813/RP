function y = psobjPanelB(x, fparameters)
...
schools = fparameters(:,6:7);
time = fparameters(:,11);
mij_emp = fparameters(:,12);
...
% data
graphdata = fparameters(:,8);
distancedata1 = fparameters(:,9);
distancedata2 = fparameters(:,10);
