log using 2_MainAnalysis_021220.log, replace

********************************************************************************
* WRITTEN BY MINSEON PARK, 021220
* MAIN ANALYSIS 
* SAME WITH MAINANLAYSIS_020920, BUT ONLY INCLUDE FIRST YEAR STUDENTS
********************************************************************************
...
g grade = floor(id/10000)
replace grade= mod(grade, 10)
keep if grade==1 // 77 percent
save Risk_ByIndiv_1st, replace

use Risk_ByPair, clear
g grade = floor(id/10000)
replace grade= mod(grade, 10)
keep if grade==1 // 77 percent
save Risk_ByPair_1st, replace
...
outreg2 using "$results_main\Reg_RiskTypeAggregation.xls", bdec(3) cdec(3) drop(i.class) label ctitle(All) addtext(Class FE, YES) replace
qui reg rdu_col i.rdupair $cov1 i.class, vce(robust)
outreg2 using "$results_main\Reg_RiskTypeAggregation.xls", bdec(3) cdec(3) drop(i.class) label ctitle(All) addtext(Class FE, YES) append
qui reg rdu_col i.rdupair $cov2 i.class, vce(robust)
outreg2 using "$results_main\Reg_RiskTypeAggregation.xls", bdec(3) cdec(3) drop(i.class) label ctitle(All) addtext(Class FE, YES) append

qui reg rdu_col i.rdupair i.class if $Imcutpair & Im_col<=$Imcut , vce(robust)
outreg2 using "$results_main\Reg_RiskTypeAggregation.xls", bdec(3) cdec(3) drop(i.class) label ctitle(I_M<=0.2) addtext(Class FE, YES) append
...
outreg2 using "$results_main\Reg_RiskTypeAggregation.xls", bdec(3) cdec(3) drop(i.class) label ctitle(I_V<=0.1) addtext(Class FE, YES) append
...
outreg2 using "$results_main\Reg_RiskpremiumAggregation.xls", bdec(3) cdec(3) ctitle(All) drop(i.class) label addtext(Class FE, YES) replace
reg riskpremium_col riskpremium_ind_max riskpremium_ind_dist $cov1 i.class, vce(robust)
outreg2 using "$results_main\Reg_RiskpremiumAggregation.xls", bdec(3) cdec(3) ctitle(All) drop(i.class) label addtext(Class FE, YES) append
...
outreg2 using "$results_main\Reg_RiskpremiumAggregation.xls", bdec(3) cdec(3) ctitle(I_M<=0.2) drop(i.class) label addtext(Class FE, YES) append
...
outreg2 using "$results_main\Reg_RiskpremiumAggregation.xls", bdec(3) cdec(3) ctitle(I_V<=0.1) drop(i.class) label addtext(Class FE, YES) append
...
outreg2 using "$results_main\Reg_RiskpremiumAggregation.xls", bdec(3) cdec(3) ctitle(I_M-I_V<=0.1) drop(i.class) label addtext(Class FE, YES) append
...
outreg2 using "$results_main/Reg_UtilityLoss.xls", bdec(3) cdec(3) ctitle(All) label replace 
...
outreg2 using "$results_main/Reg_UtilityLoss.xls", bdec(3) cdec(3) ctitle(All) label append
