...
file write cceifile "\hspace{1em}Preference distance \$I_{ig}\$ & " %6.3f (`new2_I_ig_base_mean') " & " %6.3f (`new2_I_ig_base_sd') " & " %6.3f (`new2_I_ig_base_p10') " & " %6.3f (`new2_I_ig_base_p50') " & " %6.3f (`new2_I_ig_base_p90') " & " %9.0fc (`new2_I_ig_base_N') " \\" _n
...
file write cceifile "\hspace{1em}Preference distance \$I_{ig}\$ & " %6.3f (`new2_I_ig_end_mean') " & " %6.3f (`new2_I_ig_end_sd') " & " %6.3f (`new2_I_ig_end_p10') " & " %6.3f (`new2_I_ig_end_p50') " & " %6.3f (`new2_I_ig_end_p90') " & " %9.0fc (`new2_I_ig_end_N') " \\" _n
