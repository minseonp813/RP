...
\begin{tabular}{lcccc}
\toprule
\input{results/tables/cei_ccei_models_min.tex}
\end{tabular}
...
\begin{tabular}{lcccc}
\toprule
\input{results/tables/cei_joint_mlogit_min.tex}
\end{tabular}
\begin{tablenotes}[flushleft]
\scriptsize
...
\begin{tabular}{lcccc}
\toprule
\input{results/tables/cei_ccei_models_dist.tex}
\end{tabular}
\begin{tablenotes}[flushleft]
\scriptsize
...
\begin{tabular}{lcccc}
\toprule
\input{results/tables/cei_joint_mlogit_dist.tex}
\end{tabular}
\begin{tablenotes}[flushleft]
\scriptsize
