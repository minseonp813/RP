function [minus_utility] = HPZ_Utility_Helper(prob_x,x,param1,param2,param3,flag, varargin)
...
minus_utility = alpha_multiplier * (0-HPZ_Utility(prob_x,x,param1,param2,param3,flag));