function Mat = HPZ_BI_residuals (data,obs_num,treatment,function_flag,beta_flag,zeros_flag,in_sample_flag,out_sample_flag,param_1,param_2,pref_class)
...
if in_sample_flag == 1
    ...
    for i=1:obs_num
        ...
        if numeric_flag == true
            ...
            waste = endowments(i) - HPZ_MME(param,endowments(i),Choices(i,:),treatment,function_flag,pref_class);

        else
            
            waste = endowments(i) - HPZ_MME_Analytical(Choices(i,:),param,function_flag,pref_class);
...
if out_sample_flag == 1
    ...
    for i=1:obs_num
        ...
        [p_1,p_2] = HPZ_BI_Estimation (adjusted_data,(obs_num-1),treatment,function_flag,beta_flag,zeros_flag,pref_class);
