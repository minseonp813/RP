function [aggregate] = HPZ_BI_Extreme_Param(single_param,endowment,observations,treatment,function_flag,pref_class)
...
aggregate = HPZ_BI_Criterion(param,endowment,observations,treatment,function_flag,pref_class);
