...
table_path <- "results/tables/ML/Table5.txt"
panel_path <- "data/panel_individual.dta"

panel_outputs <- tibble::tribble(
  ~panel, ~output_path, ~height,
  "A. Demographics and skills", "results/figures/ML/Figure_clan_selected_boosting_demographics.pdf", 3.2,
  "B. Friendship network", "results/figures/ML/Figure_clan_selected_boosting_network.pdf", 2.9,
  "C. Classroom environment", "results/figures/ML/Figure_clan_selected_boosting_classroom.pdf", 4.3
)
...
dir.create("results/figures/ML", recursive = TRUE, showWarnings = FALSE)
