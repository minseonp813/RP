...
dir.create("results/tables/ML", showWarnings = FALSE, recursive = TRUE)
dir.create("results/figures/ML", showWarnings = FALSE, recursive = TRUE)
dir.create("results/ML/RData", showWarnings = FALSE, recursive = TRUE)
...
save(data_scored, file = "results/ML/RData/data_with_het_score.RData")
...
print(xtable(cbind(rownames(best_ML),best_ML)), include.rownames=FALSE,file="results/tables/ML/Table2.txt", digits=3)
print(xtable(cbind(rownames(BLP_final),BLP_final)), include.rownames=FALSE,file="results/tables/ML/Table3.txt", digits=3)
print(xtable(cbind(rownames(GATES_final),GATES_final)), include.rownames=FALSE,file="results/tables/ML/Table4-1.txt", digits=3)
print(xtable(cbind(rownames(CLAN_final),CLAN_final)), include.rownames=FALSE,file="results/tables/ML/Table5.txt", digits=3)
...
for(i in 1:length(Y)){
  ...
  ggsave("results/figures/ML/Figure4.pdf", p_best, height=3.5, width=7)
}

save.image(file = "results/ML/RData/datas.RData")
